...
const AssignRecipes = () => {
  ...
  useEffect(() => {
    axios.get("http://localhost:8080/api/mealplans").then((res) => {
      setMealPlans(res.data);
    });
    axios.get("http://localhost:8080/api/recipes/public").then((res) => {
      setRecipes(res.data);
    });
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `http://localhost:8080/api/mealplans/${selectedMealPlanId}/recipes`,
        selectedRecipeIds
      );
